<template>
  <div>
    ...
    <div v-for="restaurant in filteredList" :key="restaurant.id" class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@m uk-margin" uk-grid>
      ...
      <div>
        <div class="uk-card-body">
          ...
          <router-link :to="{ name: 'restaurants-slug', params: { slug: restaurant.slug }}" tag="a" class="uk-button uk-button-primary">
            See dishes
          </router-link>
        </div>
      </div>
